...
try {
  ...
  // Fetch posts by the logged-in user with corresponding likes and comments
  $sql = "
        SELECT 
...
<body>
  ...
  <div class="hero">
    <div class="hero_container">
      <img src="../img/profile_pic.png" alt="profile" class="profile_picture" />
    </div>
  </div>
  <main>
    <div class="container">
      ...
      <?php foreach ($posts as $post): ?>
        <div class="post">
          ...
          <div class="post-meta">By <?php echo htmlspecialchars($post['author']); ?> on
            <?php echo htmlspecialchars($post['created_at']); ?></div>
          ...
          <div class="comments">
            <?php foreach ($comments as $comment): ?>
              <div class="comment">
                <div class="comment-meta"><?php echo htmlspecialchars($comment['user']); ?> on
                  <?php echo htmlspecialchars($comment['created_at']); ?></div>
